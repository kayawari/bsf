...
class Book(db.Model):
    ...
    def __init__(self, isbn: str, title: Optional[str] = None, authors: Optional[List[str]] = None,
                 publisher: Optional[str] = None, published_date: Optional[date] = None,
    ...
    def __str__(self) -> str:
        ...
        return f'{self.title} by {self.authors_display}' if self.title else f'Book {self.isbn}'